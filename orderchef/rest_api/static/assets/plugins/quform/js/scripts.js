jQuery(document).ready(function($) {
	...
	$('.recipe').on('click', function(){
		$('body').find('div.rest_div').css('display', 'none');
		$('body').find('div.recipe_div').css('display', 'block');
	});

	$('.rest').on('click', function(){
		$('body').find('div.recipe_div').css('display', 'none');
		$('body').find('div.rest_div').css('display', 'block');
	});
